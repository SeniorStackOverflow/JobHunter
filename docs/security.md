...
idempotency key: если процесс завершится после успешного ответа и до фиксации
результата, возможна повторная отправка после истечения lease. Сбой доставки не
